...
│   ├── hooks/              Event hooks (notify, statusline, shellcheck-edit, notion-write-guard, truncation-guard, fork-context-guard, agent-browser-session)
