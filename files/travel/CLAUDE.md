...
- `travel-health.sh` → deployed as `health-check-apps.sh`, sourced by the base health check: travel-vpn checks (incl. Vision cert expiry, alarm at <30d) + PrivateBin write gate.
