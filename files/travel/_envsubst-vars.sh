...
# files/scripts/roost-apply.sh (config refresh) to ensure both consumers
...
XRAY_ENVSUBST_VARS='$XRAY_UUID $XRAY_PATH $GRPC_SERVICE_NAME $REALITY_PRIVATE_KEY $REALITY_SHORT_IDS $SS2022_PASSWORD $VISION_SNI $HETZNER_PUBLIC_IPV4 $HETZNER_PUBLIC_IPV6'
