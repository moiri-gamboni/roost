...
ln -sf "$ROOST_DIR/claude/scripts/conflict-watch.py" "$HOME_DIR/bin/conflict-watch"
chown -h "$USERNAME:$USERNAME" "$HOME_DIR/bin/agent-worktree" "$HOME_DIR/bin/conflict-watch"
